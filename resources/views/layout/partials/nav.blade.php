<ul class="navbar-nav">
 ...
 <ul class="navbar-nav ms-auto"> 
    <!--begin::Navbar Search--> 
    @if(app()->getLocale() == 'vi')
      <li class="menu pt-1"><a href="{!! route('switch_language', ['en']) !!}"><img src="{{ asset('storage/uploads/flags/united-kingdom.svg') }}" alt="English" title="{{ __('English') }}" class="mx-1" style="width:24px;"></a></li>
    @else
      <li class="menu pt-1"><a href="{!! route('switch_language', ['vi']) !!}"><img src="{{ asset('storage/uploads/flags/vietnam.svg') }}" alt="Tiếng Việt" title="{{ __('Tiếng Việt') }}" class="mx-1" style="width:24px"></a></li>
    @endif
       ...
       <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> 
          ...
          <li class="user-header text-bg-primary"> 
            <x-authetication::htmls.image :name="'test.png'" object="user" alt="User Image" class="user-image rounded-circle showdow"/>  
             <p>
               @auth
                {{ auth()->user()->roles[0]->name }} | {{ auth()->user()->name }}
